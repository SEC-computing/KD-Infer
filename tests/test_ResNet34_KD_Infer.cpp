...
void reconv_relu(uint64_t* out_share, uint64_t* inp_share, uint64_t* msb_share, int lnum_relu, double &onComm_total, double &onTime_total, double &onComm_recv, double &onComm_relu, double &onTime_relu, double &onComm_recv_relu);
...
int main(int argc, char** argv) {
    ...
    string model_wts_root = "../../src/ModelAndInput/processed_weights_and_biases_resnet34/";
    string model_inp_root = "../../src/ModelAndInput/";

    /************ Prepare conv-345 ***************/
    vector<vector<uint64_t>> outArr_g;
    first_conv_out(224, 3, 7, 64, 3, 3, 2, model_inp_root+"uint64_inp.bin", model_wts_root+"onnx::Conv_345.bin", model_wts_root+"onnx::Conv_346.bin", generalData_g, outArr_g, offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_soleconv_g, Time_soleconv_g, Comm_recv_soleconv_g);
    ...
    reconv_left(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_348.bin", model_wts_root+"onnx::Conv_349.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-351***************/
    reconv_normal(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_351.bin", model_wts_root+"onnx::Conv_352.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv-354***************/
    numb_relu_g = 56*56*64;
    bool_shr_g = new uint64_t[numb_relu_g];//boolean share
    if (party == CLIENT){
        r0_g = new uint64_t[numb_relu_g];//the random share for client
    }    
    
    reconv_left(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_354.bin", model_wts_root+"onnx::Conv_355.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-357***************/
    reconv_normal(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_357.bin", model_wts_root+"onnx::Conv_358.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_360.bin", model_wts_root+"onnx::Conv_361.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-363***************/
    reconv_normal(56, 64, 3, 64, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_363.bin", model_wts_root+"onnx::Conv_364.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(56, 64, 1, 128, 0, 0, 2, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_372.bin", model_wts_root+"onnx::Conv_373.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);


    /************ Prepare conv-366***************/
    vector<vector<uint64_t>> outArr_two_g;
    reconv_right(56, 64, 3, 128, 1, 1, 2, generalData_g, outp_final_g, bool_shr_g, r0_g, outArr_two_g, imageh5, model_wts_root+"onnx::Conv_366.bin", model_wts_root+"onnx::Conv_367.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv-369***************/
    reconv_normal(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, outArr_two_g, model_wts_root+"onnx::Conv_369.bin", model_wts_root+"onnx::Conv_370.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);

    delete[] outp_final_g;
    outp_final_g = nullptr;


    /*****combine reconv 372 and reconv 369******/
    generalData_g.output_h = 28;
    generalData_g.output_w = 28;
    generalData_g.out_chans = 128;    
    ...
    /************ Prepare conv-375***************/
    numb_relu_g = 28*28*128;
    bool_shr_g = new uint64_t[numb_relu_g];//boolean share
    if (party == CLIENT){
        r0_g = new uint64_t[numb_relu_g];//the random share for client
    }

    reconv_left(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_375.bin", model_wts_root+"onnx::Conv_376.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-378***************/
    reconv_normal(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_378.bin", model_wts_root+"onnx::Conv_379.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_381.bin", model_wts_root+"onnx::Conv_382.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-384***************/
    reconv_normal(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_384.bin", model_wts_root+"onnx::Conv_385.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_387.bin", model_wts_root+"onnx::Conv_388.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-390***************/
    reconv_normal(28, 128, 3, 128, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_390.bin", model_wts_root+"onnx::Conv_391.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(28, 128, 1, 256, 0, 0, 2, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_399.bin", model_wts_root+"onnx::Conv_400.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);


    /************ Prepare conv-393***************/
    reconv_right(28, 128, 3, 256, 1, 1, 2, generalData_g, outp_final_g, bool_shr_g, r0_g, outArr_two_g, imageh5, model_wts_root+"onnx::Conv_393.bin", model_wts_root+"onnx::Conv_394.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv-396***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_two_g, model_wts_root+"onnx::Conv_396.bin", model_wts_root+"onnx::Conv_397.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /*****combine reconv 399 and reconv 396******/
    generalData_g.output_h = 14;
    generalData_g.output_w = 14;
    generalData_g.out_chans = 256;    
    for(int i = 0; i < generalData_g.out_chans; i++) {
    ...
    /************ Prepare conv-402***************/
    numb_relu_g = 14*14*256;
    bool_shr_g = new uint64_t[numb_relu_g];//boolean share
    if (party == CLIENT){
        r0_g = new uint64_t[numb_relu_g];//the random share for client
    }
    
    reconv_left(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_402.bin", model_wts_root+"onnx::Conv_403.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-405***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_405.bin", model_wts_root+"onnx::Conv_406.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_408.bin", model_wts_root+"onnx::Conv_409.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-411***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_411.bin", model_wts_root+"onnx::Conv_412.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_414.bin", model_wts_root+"onnx::Conv_415.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-417***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_417.bin", model_wts_root+"onnx::Conv_418.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_420.bin", model_wts_root+"onnx::Conv_421.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-423***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_423.bin", model_wts_root+"onnx::Conv_424.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_426.bin", model_wts_root+"onnx::Conv_427.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-429***************/
    reconv_normal(14, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_429.bin", model_wts_root+"onnx::Conv_430.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(14, 256, 1, 512, 0, 0, 2, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_438.bin", model_wts_root+"onnx::Conv_439.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);


    /************ Prepare conv-432***************/
    reconv_right(14, 256, 3, 512, 1, 1, 2, generalData_g, outp_final_g, bool_shr_g, r0_g, outArr_two_g, imageh5, model_wts_root+"onnx::Conv_432.bin", model_wts_root+"onnx::Conv_433.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv-435***************/
    reconv_normal(7, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, outArr_two_g, model_wts_root+"onnx::Conv_435.bin", model_wts_root+"onnx::Conv_436.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);

    delete[] outp_final_g;
    outp_final_g = nullptr;


    /*****combine reconv 438 and reconv 435******/
    generalData_g.output_h = 7;
    generalData_g.output_w = 7;
    generalData_g.out_chans = 512;    
    for(int i = 0; i < generalData_g.out_chans; i++) {
    ...
    reconv_left(7, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_441.bin", model_wts_root+"onnx::Conv_442.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-444***************/
    reconv_normal(7, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_444.bin", model_wts_root+"onnx::Conv_445.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    reconv_left(7, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, bool_shr_g, outArr_g, imageh5, r0_g, model_wts_root+"onnx::Conv_447.bin", model_wts_root+"onnx::Conv_448.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    if(party == CLIENT){
        delete[] r0_g;
        r0_g = nullptr;
    }
    ...
    /************ Prepare conv-450***************/
    reconv_normal(7, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"onnx::Conv_450.bin", model_wts_root+"onnx::Conv_451.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /****************FC output*******************/
    final_fc_max(outp_final_g, 6, 512, 1000, model_wts_root+"fc.weight.bin", model_wts_root+"fc.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_solefc_g, Time_solefc_g, Comm_recv_solefc_g, Comm_argmax_g, Time_argmax_g, Comm_argmax_recv_g);
...
void reconv_left(int image_h, int inp_chans, int filter_h, int out_chans, int pad_l, int pad_r, int stride, ConvMetadata &generalData, uint64_t *outp_final, uint64_t *bool_shr, vector<vector<uint64_t>> &outArr, Image &imageH5, uint64_t *r0, string wts_addr, string bs_addr, double &offComm_total, double &onComm_total, double &offTime_total, double &onTime_total, double &offComm_recv, double &onComm_recv, int SC_inp = 12, int SC_wts = 12, int N = 1){
    ...
    if(party == SERVER){
        ...
        //gets partial share for an input
        for(int i = 0; i < CO; i++){
            for(int j = 0; j < col_widthR0; j++){
                outArr[i][j] = shr12off[i][j];
            }
...
void reconv_right(int image_h, int inp_chans, int filter_h, int out_chans, int pad_l, int pad_r, int stride, ConvMetadata &generalData, uint64_t *outp_final, uint64_t *bool_shr, uint64_t *r0, vector<vector<uint64_t>> &outArr_two, Image &imageH5, string wts_addr, string bs_addr, double &offComm_total, double &onComm_total, double &offTime_total, double &onTime_total, double &offComm_recv, double &onComm_recv, int SC_inp = 12, int SC_wts = 12, int N = 1){
    ...
    long long t_off = time_from(start_offline);
    uint64_t offcomm_end = io->counter;
    cout << "reconv: Comm. Sent at offline per input (MiB): " << (offcomm_end - offcomm_start)/(1.0*(1ULL << 20)*generalData.chans_per_cipher) << endl;
    cout <<"reconv: Offline Time per input (l=" << l << "; b=" << b << ") " << t_off * 1.0 / (1000*generalData.chans_per_cipher) <<" ms"<< endl;
    offComm_total += ((offcomm_end - offcomm_start)/(1.0*(1ULL << 20)*generalData.chans_per_cipher));
    offTime_total += (t_off * 1.0 / (1000*generalData.chans_per_cipher));    
    if(party == CLIENT){
        ...
        io->recv_data(&myRecev, sizeof(uint64_t));
        offComm_recv += (myRecev / (1.0*(1ULL << 20)*generalData.chans_per_cipher));
        //cout << "reconv: Comm. Sent & Recv-ed at offline (MiB): " << (offcomm_end - offcomm_start + myRecev)/(1.0*(1ULL << 20)*generalData.chans_per_cipher) << endl;
    }    
    /********************************************/
