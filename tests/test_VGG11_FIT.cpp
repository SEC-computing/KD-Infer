...
int main(int argc, char** argv) {
    ...
    string model_wts_root = "../../src/ModelAndInput/processed_weights_and_biases_vgg11/";
    string model_inp_root = "../../src/ModelAndInput/";

    /************ Prepare conv 1 ***************/
    //use stride 2 to avoid the following maxpooling layer
    vector<vector<uint64_t>> outArr_g;
    first_conv_out(224, 3, 3, 64, 1, 1, 2, model_inp_root+"uint64_inp.bin", model_wts_root+"features.0.weight.bin", model_wts_root+"features.0.bias.bin", generalData_g, outArr_g, offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_soleconv_g, Time_soleconv_g, Comm_recv_soleconv_g);


    /********form the input of truncation********/
    generalData_g.output_h = 112;
    generalData_g.output_w = 112;
    ...
    for (int i = 0; i < generalData_g.out_chans; i++){
        for (int j = 0; j < generalData_g.output_h*generalData_g.output_w; j++){
            x_g[i*(generalData_g.output_h*generalData_g.output_w)+j] = outArr_g[i][j];
        }
    }
    ...
    /************ Prepare conv 2***************/  
    reconv_normal(112, 64, 3, 128, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.3.weight.bin", model_wts_root+"features.3.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /***************maxpooling*******************/
    generalData_g.inp_chans = 128;
    generalData_g.image_h = 112;
    generalData_g.image_w = 112;
    generalData_g.filter_h = 2;
    generalData_g.filter_w = 2;
    generalData_g.stride_h = 2;
    generalData_g.stride_w = 2;
    generalData_g.pad_t = 0;
    generalData_g.pad_b = 0;
    generalData_g.pad_l = 0;
    generalData_g.pad_r = 0;
    ...
    /************ Prepare conv 3***************/
    reconv_normal(56, 128, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.6.weight.bin", model_wts_root+"features.6.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv 4***************/
    reconv_normal(56, 256, 3, 256, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.8.weight.bin", model_wts_root+"features.8.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    generalData_g.image_h = 56;
    generalData_g.image_w = 56;
    generalData_g.filter_h = 2;
    generalData_g.filter_w = 2;
    generalData_g.stride_h = 2;
    generalData_g.stride_w = 2;
    ...
    /************ Prepare conv 5***************/
    reconv_normal(28, 256, 3, 512, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.11.weight.bin", model_wts_root+"features.11.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv 6***************/
    reconv_normal(28, 512, 3, 512, 1, 1, 2, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.13.weight.bin", model_wts_root+"features.13.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv 7***************/
    reconv_normal(14, 512, 3, 512, 1, 1, 1, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.16.weight.bin", model_wts_root+"features.16.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    /************ Prepare conv 8***************/
    reconv_normal(14, 512, 3, 512, 1, 1, 2, generalData_g, outp_final_g, outArr_g, model_wts_root+"features.18.weight.bin", model_wts_root+"features.18.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g);
    ...
    sole_relu(relu_g, x_g, div_num_g, onComm_total_g, onTime_total_g, onComm_recv_g, Comm_relu_g, Time_relu_g, Comm_recv_relu_g);
    delete[] x_g;
    x_g = nullptr;
    outArr_g = vector<vector<uint64_t>>();
    ...
    consSF_g = 12;
    outp_final_g = new uint64_t[div_num_g];
    trunc_func(div_num_g, consSF_g, outp_final_g, relu_g, onComm_total_g, onTime_total_g, onComm_recv_g, Comm_trunc_g, Time_trunc_g, Comm_recv_trunc_g);
    delete[] relu_g;
    relu_g = nullptr;  
    ...
    for(int i = 0; i < num_pieces; i++){
        ...
        sole_fc(outp_final_g, outFC_local, col_start_g, col_end_g, 12, 25088, 4096, model_wts_root+"classifier.0.weight.bin", model_wts_root+"classifier.0.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_solefc_g, Time_solefc_g, Comm_recv_solefc_g);
    ...
    sole_fc(relu_g, outFC, 0, 4095, 12, 4096, 4096, model_wts_root+"classifier.3.weight.bin", model_wts_root+"classifier.3.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_solefc_g, Time_solefc_g, Comm_recv_solefc_g);
...
void final_fc_max(uint64_t *outp_final, int x_scales, int inp_dim, int out_dim, string wts_addr, string bs_addr, double &offComm_total, double &onComm_total, double &offTime_total, double &onTime_total, double &offComm_recv, double &onComm_recv, double &Comm_solefc, double &Time_solefc, double &Comm_solefc_recv, double &Comm_argmax, double &Time_argmax, double &Comm_argmax_recv){
    ...
    int slot_count =  min(SEAL_POLY_MOD_DEGREE_MAX, max(8192, next_pow2(out_dim)));
    shared_ptr<SEALContext> context_;
    Encryptor* encryptor_;
    Decryptor* decryptor_;
    Evaluator* evaluator_;
...
void sole_fc(uint64_t *outp_final, uint64_t *outFC, int col_start, int col_end, int x_scales, int inp_dim, int out_dim, string wts_addr, string bs_addr, double &offComm_total, double &onComm_total, double &offTime_total, double &onTime_total, double &offComm_recv, double &onComm_recv, double &Comm_solefc, double &Time_solefc, double &Comm_solefc_recv){
    ...
    if(party == CLIENT){
        ...
        int num_per_cipher = slot_count / out_dim;
        int num_ct_r0 = ceil(1.0*(col_end - col_start + 1) / num_per_cipher);
        vector<Ciphertext> enc_r0(num_ct_r0);
        #pragma omp parallel for num_threads(numThreads) schedule(static)
        for(int i = 0; i < num_ct_r0; i++){
            vector<uint64_t> v1(slot_count, 0ULL);
            ...
            int idx_offset = i * num_per_cipher;
            if(i == (num_ct_r0 - 1)){
                for(int j = 0; j < ((col_end - col_start + 1) - idx_offset); j++){
                    for(int k = 0; k < out_dim; k++){
                        v1[j * out_dim + k] = neg_mod((int64_t)r0[idx_offset + j],prime_mod);
                    }
                }
    ...
    if(party == CLIENT){
        ...
        for(int i = col_start; i < (col_end + 1); i++){
            mask_inp(i - col_start, 0) = neg_mod(((int64_t)outp_final[i] - (int64_t)r0[i - col_start]), prime_mod);
        }
        //send the masked input to server
