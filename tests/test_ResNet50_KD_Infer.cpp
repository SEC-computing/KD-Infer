...
int main(int argc, char** argv) {
    ...
    double onComm_relu_g = 0, onTime_relu_g = 0, onComm_recv_relu_g = 0;
    double onComm_trunc_g = 0, onTime_trunc_g = 0, onComm_recv_trunc_g = 0;
    double Comm_soleconv_g = 0, Time_soleconv_g = 0, Comm_soleconv_recv_g = 0;
    double Comm_mxp_g = 0, Time_mxp_g = 0, Comm_recv_mxp_g = 0;
    double Comm_solefc_g = 0, Time_solefc_g = 0, Comm_solefc_recv_g = 0;
    ...
    first_conv_out(224, 3, 7, 64, 3, 3, 2, model_inp_root+"uint64_inp.bin", model_wts_root+"onnx::Conv_497.bin", model_wts_root+"onnx::Conv_498.bin", generalData_g, outArr_g, offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_soleconv_g, Time_soleconv_g, Comm_soleconv_recv_g);
    ...
    trunc_func(div_num_g, consSF_g, outp_final_g, x_g, onComm_total_g, onTime_total_g, onComm_recv_g, onComm_trunc_g, onTime_trunc_g, onComm_recv_trunc_g);
    delete[] x_g;
    x_g = nullptr;
    ...
    reconv_relu(relu_g, outp_final_g, bool_shr_g, number_relu_g, onComm_total_g, onTime_total_g, onComm_recv_g, onComm_relu_g, onTime_relu_g, onComm_recv_relu_g);
    ...
    sole_relu(relu_g, outp_final_g, div_num_g, onComm_total_g, onTime_total_g, onComm_recv_g, onComm_relu_g, onTime_relu_g, onComm_recv_relu_g);
    delete[] outp_final_g;
    outp_final_g = nullptr;
    ...
    outp_final_g = new uint64_t[div_num_g];
    sole_div(div_num_g, divisor_g, div_bits_g, avrg_pool, outp_final_g, onComm_total_g, onTime_total_g, onComm_recv_g, onComm_trunc_g, onTime_trunc_g, onComm_recv_trunc_g);
    ...
    /****************FC output*******************/
    final_fc_max(outp_final_g, 6, 2048, 1000, model_wts_root+"fc.weight.bin", model_wts_root+"fc.bias.bin", offComm_total_g, onComm_total_g, offTime_total_g, onTime_total_g, offComm_recv_g, onComm_recv_g, Comm_solefc_g, Time_solefc_g, Comm_solefc_recv_g, Comm_argmax_g, Time_argmax_g, Comm_argmax_recv_g);
    ...
    cout <<"------------------------" << endl;
    cout << "Each Input(sole relu): Comm. Sent (MiB): " << (onComm_relu_g) << endl;
    if(party == SERVER){
        cout << "          : Comm. Sent & Recv-ed (MiB): " << (onComm_relu_g + onComm_recv_relu_g) << endl;
    }
    cout << "          : Time (l=" << l << "; b=" << b << ") " << (onTime_relu_g) <<" ms"<< endl;
    cout <<"------------------------" << endl;
    cout << "Each Input(trunc.): Comm. Sent (MiB): " << (onComm_trunc_g) << endl;
    if(party == SERVER){
        cout << "          : Comm. Sent & Recv-ed (MiB): " << (onComm_trunc_g + onComm_recv_trunc_g) << endl;
    }
    cout << "          : Time (l=" << l << "; b=" << b << ") " << (onTime_trunc_g) <<" ms"<< endl;    
cout <<"------------------------" << endl;
    cout << "Each Input(sole conv.): Comm. Sent (MiB): " << (Comm_soleconv_g) << endl;
    if(party == SERVER){
        cout << "          : Comm. Sent & Recv-ed (MiB): " << (Comm_soleconv_g + Comm_soleconv_recv_g) << endl;
    }
...
cout <<"------------------------" << endl;
    ...
    if(party == SERVER){
        cout << "          : Comm. Sent & Recv-ed (MiB): " << (Comm_solefc_g + Comm_solefc_recv_g) << endl;
    }
...
cout <<"------------------------" << endl;
    cout << "Each Input(reconv): Comm. Sent (MiB): " << (offComm_total_g + onComm_total_g - Comm_argmax_g - Comm_solefc_g - Comm_soleconv_g - Comm_mxp_g - onComm_trunc_g - onComm_relu_g) << endl;
    if(party == SERVER){
        cout << "          : Comm. Sent & Recv-ed (MiB): " << (offComm_total_g + offComm_recv_g + onComm_total_g + onComm_recv_g - (onComm_relu_g + onComm_recv_relu_g) - (onComm_trunc_g + onComm_recv_trunc_g) - (Comm_soleconv_g + Comm_soleconv_recv_g) - (Comm_argmax_g + Comm_argmax_recv_g) - (Comm_solefc_g + Comm_solefc_recv_g) - (Comm_mxp_g + Comm_recv_mxp_g)) << endl;
    }
    cout << "          : Time (l=" << l << "; b=" << b << ") " << (offTime_total_g + onTime_total_g - Time_argmax_g - Time_solefc_g - Time_soleconv_g - Time_mxp_g - onTime_trunc_g - onTime_relu_g) <<" ms"<< endl; 
    cout <<"========================" << endl;
